...
Grab the latest installer from the [**releases page**](https://github.com/guan4tou2/REDLOG/releases/latest) — current version **v0.6.73**:

| Platform | File |
|----------|------|
| macOS (Apple Silicon) | [`RedLog-0.6.66-arm64.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.73/RedLog-0.6.66-arm64.dmg) |
| macOS (Intel) | [`RedLog-0.6.66.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.73/RedLog-0.6.66.dmg) |
| Windows (installer) | [`RedLog.Setup.0.6.66.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.73/RedLog.Setup.0.6.66.exe) |
| Windows (portable) | [`RedLog.0.6.66.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.73/RedLog.0.6.66.exe) |
