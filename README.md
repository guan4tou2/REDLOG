...
Grab the latest installer from the [**releases page**](https://github.com/guan4tou2/REDLOG/releases/latest) — current version **v0.3.0**:

| Platform | File |
|----------|------|
| macOS (Apple Silicon) | [`RedLog-0.3.0-arm64.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.3.0/RedLog-0.3.0-arm64.dmg) |
| macOS (Intel) | [`RedLog-0.3.0.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.3.0/RedLog-0.3.0.dmg) |
| Windows (installer) | [`RedLog.Setup.0.3.0.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.3.0/RedLog.Setup.0.3.0.exe) |
| Windows (portable) | [`RedLog.0.3.0.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.3.0/RedLog.0.3.0.exe) |
