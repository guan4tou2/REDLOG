...
Grab the latest installer from the [**releases page**](https://github.com/guan4tou2/REDLOG/releases/latest) — current version **v0.4.6**:

| Platform | File |
|----------|------|
| macOS (Apple Silicon) | [`RedLog-0.4.6-arm64.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.4.6/RedLog-0.4.6-arm64.dmg) |
| macOS (Intel) | [`RedLog-0.4.6.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.4.6/RedLog-0.4.6.dmg) |
| Windows (installer) | [`RedLog.Setup.0.4.6.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.4.6/RedLog.Setup.0.4.6.exe) |
| Windows (portable) | [`RedLog.0.4.6.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.4.6/RedLog.0.4.6.exe) |
