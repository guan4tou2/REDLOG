...
Grab the latest installer from the [**releases page**](https://github.com/guan4tou2/REDLOG/releases/latest) — current version **v0.9.9**:

| Platform | File |
|----------|------|
| macOS (Apple Silicon) | [`RedLog-0.9.9-arm64.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.9.9/RedLog-0.9.9-arm64.dmg) |
| Windows (installer) | [`RedLog.Setup.0.9.9.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.9.9/RedLog.Setup.0.9.9.exe) |
| Windows (portable) | [`RedLog.0.9.9.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.9.9/RedLog.0.9.9.exe) |
