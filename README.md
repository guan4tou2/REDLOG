...
Grab the latest installer from the [**releases page**](https://github.com/guan4tou2/REDLOG/releases/latest) — current version **v0.6.51**:

| Platform | File |
|----------|------|
| macOS (Apple Silicon) | [`RedLog-0.6.51-arm64.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.51/RedLog-0.6.51-arm64.dmg) |
| macOS (Intel) | [`RedLog-0.6.51.dmg`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.51/RedLog-0.6.51.dmg) |
| Windows (installer) | [`RedLog.Setup.0.6.51.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.51/RedLog.Setup.0.6.51.exe) |
| Windows (portable) | [`RedLog.0.6.51.exe`](https://github.com/guan4tou2/REDLOG/releases/download/v0.6.51/RedLog.0.6.51.exe) |
